...
Данный гайд описывает, как превратить ваш домашний компьютер в персональный узел разблокировок. Вы сможете использовать **Zapret (winws)** и **TgWsProxy** с мобильного телефона через 4G/5G в любой точке мира.
...
### ⚙️ ШАГ 2. Настройка Tailscale на ПК (Exit Node)
