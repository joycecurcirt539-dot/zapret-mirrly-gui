...
16. [Обратная связь и репорты об ошибках](#обратная-связь-и-репорты-об-ошибках)
17. [Зависимости и благодарности](#зависимости-и-благодарности)
...
- [x] Полный перенос на WinUI 3 с аппаратным размытием Mica и Acrylic (DWM).
- [x] Внедрение встроенного Telegram WebSocket-прокси на C# (.NET 10).
- [x] Автоматическое обучение списка заблокированных доменов (`autohostlist.txt`).
- [x] Интерактивный диагностический модуль тестирования сетевых подключений.
- [ ] Автоматический подбор наилучшего пресета обхода по пингу и отклику ресурсов.
- [ ] Поддержка пользовательских скриптов обработки пакетов на языке Lua.
