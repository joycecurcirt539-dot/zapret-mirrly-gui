...
Приложение поддерживает гибкую кастомизацию внешнего вида под любые типы экранов:
* **Чёрный графит (AMOLED):** 100% pitch black (#000000) фон для OLED и AMOLED дисплеев с максимальным энергосбережением и прозрачными плашками элементов управления.
* **Светлая тема:** Контрастный, яркий дизайн с подложкой в стиле матового стекла (Apple Light Glass).
* **Тёмная тема:** Глубокий графитовый стиль для работы в условиях низкой освещенности.
* **Composition API & DWM:** Прямое управление параметрами `DWMWA_USE_IMMERSIVE_DARK_MODE` гарантирует нативную отрисовку оптических эффектов Acrylic и Mica без вылетов и тормозов.
