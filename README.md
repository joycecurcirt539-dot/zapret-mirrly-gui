...
- [x] Интерактивный диагностический модуль проверки сетевой подсистемы (`test zapret.ps1`).
- [x] Автоматическое тестирование и ранжирование эффективных пресетов обхода доменов в модуле диагностики (Strategy Scoring & Benchmark).
- [x] Живой светокодированный журнал логов в реальном времени с фильтрацией по ошибкам/уведомлениям и быстрому экспорту.
- [x] Селективная фильтрация по сетевым протоколам (IPv4 / IPv6).

### В разработке и планах на будущие релизы:
- [ ] **Автоматическое применение лучшей стратегии:** Мгновенное применение оптимального пресета на Главную панель по итогам проведенного тестирования.
...
- [ ] **Поддержка скриптов Lua:** Прямой запуск и отладка кастомных Lua-сценариев модификации пакетов `winws`.
